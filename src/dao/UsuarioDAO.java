...
public class UsuarioDAO implements ICRUD<UsuarioDTO>{
    ...
    public UsuarioDTO readByUsername(String username) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                user.setTipoUsuario(tipoDAO.readByID(rs.getInt(10)));
    ...
    public UsuarioDTO update(UsuarioDTO usuario) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "¡Error Al Actualizar Registro Usuario!\n" + e.getMessage());
        }
            return null;
    }
    ...
    public int delete(int id) {        
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "¡Error Al Eliminar Registro Usuario!\n" + e.getMessage());
        }
